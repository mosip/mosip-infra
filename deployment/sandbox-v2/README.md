...
_**WARNING**: The sandbox is not intented to be used for serious pilots or production.  Do not run the sandbox with any confidential data. It is highly recommended that you install your sandbox using [V3](../v3) deployment which is a production grade deploynment. The V2 installer shall be depcrecated soon._ 
