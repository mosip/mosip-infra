# Resident Module certificate exchange guide 
...
- Below are the steps needed to be performed for the certificate exchange of Resident
  ...
  * 8. Upload the response signinng certificate obtained from the reponse of the above api into the keymanager for mpartner-default-resident partner in keymanager using below Swagger URL:https://minibox2.mosip.net/v1/keymanager/swagger-ui.html#/keymanager/uploadOtherDomainCertificateUsingPOST```  keymanager --> /uploadOtherDomainCertificate with below request
	```
	{
	  "id": "string",
	  "metadata": {},
