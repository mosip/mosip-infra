...
def main():
    ...
    r = mosip.generate_master_key('ROOT', 'MOSIP') 
    r = mosip.generate_master_key('KERNEL', 'MOSIP-KERNEL-SIGN', 'SIGN') 
    r = mosip.generate_master_key('KERNEL', 'MOSIP-KERNEL') 
    r = mosip.generate_master_key('REGISTRATION', 'MOSIP-REGISTRATION') 
    r = mosip.generate_master_key('PRE_REGISTRATION', 'MOSIP-PRE_REGISTRATION') 
    r = mosip.generate_master_key('REGISTRATION_PROCESSOR', 'MOSIP-REGISTRATION_PROCESSOR') 
    r = mosip.generate_master_key('ID_REPO', 'MOSIP-ID_REPO') 
    #print_response(r)
