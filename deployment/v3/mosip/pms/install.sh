...
function installing_pms() {
  ...
  helm -n $NS install pmp-ui mosip/pmp-ui  --set image.repository=mosipid/pmp-ui --set image.tag=1.2.0.1-B1 --set pmp.apiUrl=https://$INTERNAL_API_HOST/ --set istio.hosts=["$PMP_HOST"] --version $PMP_UI_CHART_VERSION
