...
helm -n $NS install authmanager mosip/authmanager --set image.repository=mosipdev/kernel-auditmanager-service --set image.tag=1.2.0.1-B2 --version $CHART_VERSION
