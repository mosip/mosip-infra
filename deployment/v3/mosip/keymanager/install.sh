...
function installing_keymanager() {
  ...
  helm -n $NS install keymanager mosip/keymanager --set image.repository=mosipid/kernel-keymanager-service --set image.tag=release-1.2.0.1-B4 --version $CHART_VERSION
