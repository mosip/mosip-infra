...
if [ $yn = "Y" ] 
  then
   ...
   helm -n $NS install masterdata-loader  mosip/masterdata-loader --set mosipDataGithubBranch=develop --set image.repository=mosipdev/masterdata-loader  --version $CHART_VERSION --wait
