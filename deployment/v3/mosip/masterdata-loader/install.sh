...
if [ $yn = "Y" ]
  then
   ...
   helm -n $NS install masterdata-loader  mosip/masterdata-loader --set image.repository=mosipid/masterdata-loader --set image.tag=1.2.0.1 --set mosipDataGithubBranch=1.2.0.1 --version $CHART_VERSION --wait
